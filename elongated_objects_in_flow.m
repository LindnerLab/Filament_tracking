...
basepath='E:\Helicies in flow-Faustine&Martyna\Faustine\';
...
% define the polarity of the object: 
% 0 = bright feature on a dark background
% 1 = dark feature over a bright background
inv = 0;
...
% thickness of the filament in px ** ARRAY ARE ALLOWED
thickness = 5:7; 
% threshold for differentiating the tubular structure from the background
structsensitivity = 1; % between 0.5 and 1. 

% define some parameters for the gaussian blur
lnoise = 3; % characteristic lengthscale of noise in pixels
lobject = 10; % typical object size
threshold = 0.08; % threshhold for setting pixels to 0 after convolution with gaussian kernel

% define some parameters for morphological operations
sensitivity=0.9; % sensitivity for adaptive image binarization 
...
npnts = 2; % number of points per interval in the recontructed B-spline centerline

%% RESULTS

xy = elongated_objects_trajectories(basepath,batch,tifname,inv,thickness,...
